...
- Narrow screens up to 600px now use independently adjustable 22px body text through `--mb-mobile-font-size`, without changing desktop or tag sizes.
...
- 宽度不超过 600px 的窄屏现在默认使用可独立调节的 22px 正文，可通过 `--mb-mobile-font-size` 修改，不影响桌面和标签字号。
